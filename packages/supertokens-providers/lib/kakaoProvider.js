...
var Kakao = function (_a) {
    ...
    return ({
        ...
        get: function (redirectURI, authCodeFromRequest, userContext) {
            ...
            var secret = clientSecret ? { client_secret: clientSecret } : undefined;
            return {
                accessTokenAPI: {
                    // https://developers.kakao.com/docs/latest/ko/kakaologin/rest-api#request-token
                    url: "https://kauth.kakao.com/oauth/token",
                    params: __assign({ client_id: clientId, redirect_uri: redirectURI || redirectUrl || "".concat(unionRedirectUrl) || "", response_type: "code", grant_type: "authorization_code", code: authCodeFromRequest || "" }, secret),
                },
                ...
                getProfileInfo: function (accessTokenAPIResponse) { return __awaiter(void 0, void 0, void 0, function () {
                    var access_token, result, _a, id, kakao_account, has_email, email, is_email_verified;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, axios_1.default.get("https://kapi.kakao.com/v2/user/me", {
                                        headers: {
                            ...
                            case 1:
                                result = _b.sent();
                                _a = result.data, id = _a.id, kakao_account = _a.kakao_account;
                                if (!kakao_account)
                                    throw new Error("No Kakao account");
                                has_email = kakao_account.has_email, email = kakao_account.email, is_email_verified = kakao_account.is_email_verified;
                                if (!has_email)
                                    throw new Error("No email in this account");
                                if (!email)
...
exports.Kakao = Kakao;
//# sourceMappingURL=kakaoProvider.js.map